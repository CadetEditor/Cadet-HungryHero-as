...
package hungryHero.font
{
	...
	public class Fonts
	{
		 ...
		 */		
		[Embed(source="../assets/hungryHero/fonts/bitmap/fontRegular.png")]
		public static const Font_Regular:Class;
		
		[Embed(source="../assets/hungryHero/fonts/bitmap/fontRegular.fnt", mimeType="application/octet-stream")]
		public static const XML_Regular:Class;
		
		/**
		 * Font for score label. 
		 */		
		[Embed(source="../assets/hungryHero/fonts/bitmap/fontScoreLabel.png")]
		public static const Font_ScoreLabel:Class;
		
		[Embed(source="../assets/hungryHero/fonts/bitmap/fontScoreLabel.fnt", mimeType="application/octet-stream")]
		public static const XML_ScoreLabel:Class;
		
		/**
		 * Font for score value. 
		 */		
		[Embed(source="../assets/hungryHero/fonts/bitmap/fontScoreValue.png")]
		public static const Font_ScoreValue:Class;
		
		[Embed(source="../assets/hungryHero/fonts/bitmap/fontScoreValue.fnt", mimeType="application/octet-stream")]
