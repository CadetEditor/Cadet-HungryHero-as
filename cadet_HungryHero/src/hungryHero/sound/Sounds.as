...
package hungryHero.sound
{
	...
	public class Sounds extends EventDispatcher
	{
		...
		[Embed(source="../assets/hungryHero/sounds/bgWelcome.mp3")]
		public static const SND_BG_MAIN:Class;
		
		[Embed(source="../assets/hungryHero/sounds/coffee.mp3")]
		public static const SND_COFFEE:Class;
		
		[Embed(source="../assets/hungryHero/sounds/mushroom.mp3")]
