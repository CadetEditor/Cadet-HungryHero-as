package hungryHero.managers
{
	import flash.utils.Dictionary;
	
	import hungryHero.controller.IController;
	
	import hungryHero.events.ViewManagerEvent;
	
	import starling.display.DisplayObjectContainer;
	import starling.events.EventDispatcher;
	
	[Event(type="hungryHero.events.ViewManagerEvent", name="viewChange")]
	...
	public class ViewManager extends EventDispatcher
	{
		...
		private var _currentController		:hungryHero.controller.IController;
